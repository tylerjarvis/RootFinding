...
def dex13():
    df = lambda x,y,z,x4: (-3*(-0.8+x)**2*(np.exp(2*y-2*z)-x**3)*((0.2+np.exp(y-z))**2-(0.8+x)**3)*(-(-0.3+x)**3+(-0.7+y)**2)-3*(-0.3+x)**2*(np.exp(2*y-2*z)-x**3)*((0.2+np.exp(y-z))**2-(0.8+x)**3)*(-(-0.8+x)**3+(0.2+y)**2)-3*(0.8+x)**2*(np.exp(2*y-2*z)-x**3)*(-(-0.3+x)**3+(-0.7+y)**2)*(-(-0.8+x)**3+(0.2+y)**2)-3*x**2*((0.2+np.exp(y-z))**2-(0.8+x)**3)*(-(-0.3+x)**3+(-0.7+y)**2)*(-(-0.8+x)**3+(0.2+y)**2),
                            2*(np.exp(2*y-2*z)-x**3)*((0.2+np.exp(y-z))**2-(0.8+x)**3)*(-(-0.3+x)**3+(-0.7+y)**2)*(0.2+y)+2*np.exp(y-z)*(0.2+np.exp(y-z))*(np.exp(2*y-2*z)-x**3)*(-(-0.3+x)**3+(-0.7+y)**2)*(-(-0.8+x)**3+(0.2+y)**2)+2*np.exp(2*y-2*z)*((0.2+np.exp^(y-z))**2-(0.8+x)**3)*(-(-0.3+x)**3+(-0.7+y)**2)*(-(-0.8+x)**3+(0.2+y)**2)+2*(np.exp(2*y-2*z)-x**3)*((0.2+np.exp(y-z))**2-(0.8+x)**3)*(-0.7+y)*(-(-0.8+x)**3+(0.2+y)**2),
                            2*np.exp(y-2*z)*(-2*np.exp(3*y-2*z)-0.6*np.exp(2*y-z)+0.2*np.exp(z)*x**3+2*np.exp(y)*(0.236+0.96*x+1.2*x**2+x**3))*(-1*(-0.3+x)**3+(-0.7+y)**2)*(-1*(-0.8+x)**3+(0.2+y)**2),
                            0)
    dg = lambda x,y,z,x4: ((-2*((0.4+np.exp(y-z))**3-1*(-0.4+x)**2)*((0.3+np.exp(y-z))**3-8*(-0.4+x)**3)*((0.3+np.exp(y-z))**3-1*(-0.3+x)**2)*(0.6+x)-2*((0.3+np.exp(y-z))**3-8*(-0.4+x)**3)*((0.3+np.exp(y-z))**3-1*(-0.3+x)**2)*(-0.4+x)*((-0.5+np.exp(y-z))**3-1*(0.6+x)**2)-2*((0.4+np.exp(y-z))**3-1*(-0.4+x)**2)*((0.3+np.exp(y-z))**3-8*(-0.4+x)**3)*(-0.3+x)*((-0.5+np.exp(y-z))**3-1*(0.6+x)**2)-6*((0.4+np.exp(y-z))**3-1*(-0.4+x)**2)*((0.3+np.exp(y-z))**3-1*(-0.3+x)**2)*(-0.8+2*x)**2*((-0.5+np.exp(y-z))**3-1*(0.6+x)**2)),
                            3*np.exp(y-z)*((-0.5+np.exp(y-z))**2*((0.4+np.exp(y-z))**3-1*(-0.4+x)**2)*((0.3+np.exp(y-z))**3-8*(-0.4+x)**3)*((0.3+np.exp(y-z))**3-1*(-0.3+x)**2)+(0.3+np.exp(y-z))**2*((0.4+np.exp(y-z))**3-1*(-0.4+x)**2)*((0.3+np.exp(y-z))**3-8*(-0.4+x)**3)*((-0.5+np.exp(y-z))**3-1*(0.6+x)**2)+(0.3+np.exp(y-z))**2*((0.4+np.exp(y-z))**3-1*(-0.4+x)**2)*((0.3+np.exp(y-z))**3-1*(-0.3+x)**2)*((-0.5+np.exp(y-z))**3-1*(0.6+x)**2)+(0.4+np.exp(y-z))**2*((0.3+np.exp(y-z))**3-8*(-0.4+x)**3)*((0.3+np.exp(y-z))**3-1*(-0.3+x)**2)*((-0.5+np.exp(y-z))**3-1*(0.6+x)**2)),
                            3*np.exp(y-z)*(-(-0.5+np.exp(y-z))**2*((0.4+np.exp(y-z))**3-1*(-0.4+x)**2)*((0.3+np.exp(y-z))**3-8*(-0.4+x)**3)*((0.3+np.exp(y-z))**3-1*(-0.3+x)**2)-(0.3+np.exp(y-z))**2*((0.4+np.exp(y-z))**3-1*(-0.4+x)**2)*((0.3+np.exp(y-z))**3-8*(-0.4+x)**3)*((-0.5+np.exp(y-z))**3-1*(0.6+x)**2)-(0.3+np.exp(y-z))**2*((0.4+np.exp(y-z))**3-1*(-0.4+x)**2)*((0.3+np.exp(y-z))**3-1*(-0.3+x)**2)*((-0.5+np.exp(y-z))**3-1*(0.6+x)**2)-(0.4+np.exp(y-z))**2*((0.3+np.exp(y-z))**3-8*(-0.4+x)**3)*((0.3+np.exp(y-z))**3-1*(-0.3+x)**2)*((-0.5+np.exp(y-z))**3-1*(0.6+x)**2)),
                            ,0)
    dh = lambda x,y,z,x4: (1,1,1,0)
    df4 = lambda x,y,z,x4: (1,1,1,1)
