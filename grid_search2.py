...
# acknowledgements, etc.
    ...
    # return yr.solve(funcs, a, b, plot=plot)
...
# Run all the tests!
def get_score(rel_approx_tol, abs_approx_tol, trim_zero_tol, max_cond_num, \
              macaulay_zero_tol, min_good_zeros_tol, good_zeros_factor):

    @timeout_decorator.timeout(30, use_signals=False)
    def solve(funcs, a, b, plot=False):
        ...
        return yr.solve(funcs, a, b, rel_approx_tol=rel_approx_tol, 
    ...
    def verbose_pass_or_fail(funcs, yroots, MSroots, test_num, cheb_roots=None, tol=2.220446049250313e-13):
        ...
        if cheb_roots is not None:
            try:
                cheb_norm, x_norm, y_norm = norm_pass_or_fail(yroots, cheb_roots, tol)
        ...
        if MSroots is not None:
            try:
                MS_norm, x_norm, y_norm = norm_pass_or_fail(yroots, MSroots, tol)
                #if MS_norm:
        ...
        return residuals_pass, cheb_norm, MS_norm
    ...
    def test_roots_1_1():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 1.1, cheb_roots=chebfun_roots)
    ...
    def test_roots_1_2():
        ...
        return verbose_pass_or_fail([f,g], yroots, cheb_roots=chebfun_roots, test_num=1.2, MSroots=None)
    ...
    def test_roots_1_3():
        ...
        return verbose_pass_or_fail([f,g], yroots, MSroots, test_num=1.3, cheb_roots=chebfun_roots)
    ...
    def test_roots_1_4():
        ...
        return verbose_pass_or_fail([f,g], yroots, a_roots, test_num=1.4)
    ...
    def test_roots_1_5():
        ...
        return verbose_pass_or_fail([f,g], yroots, a_roots, 1.5)
    ...
    def test_roots_2_1():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 2.1, cheb_roots=chebfun_roots)
    ...
    def test_roots_2_2():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 2.2, cheb_roots=chebfun_roots)
    ...
    def test_roots_2_3():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 2.3, cheb_roots=chebfun_roots)
    ...
    def test_roots_2_4():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 2.4, cheb_roots=chebfun_roots)
    ...
    def test_roots_2_5():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 2.5, tol=2.220446049250313e-12, cheb_roots=chebfun_roots)
    ...
    def test_roots_3_1():
        ...
        return verbose_pass_or_fail([f,g], yroots, MSroots=None, test_num=3.1, cheb_roots=chebfun_roots)
    ...
    def test_roots_3_2():
        ...
        return verbose_pass_or_fail([f,g], yroots, MSroots=None, cheb_roots=chebfun_roots, test_num=3.2)
    ...
    def test_roots_4_1():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 4.1, cheb_roots=chebfun_roots)
    ...
    def test_roots_4_2():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 4.2, cheb_roots=chebfun_roots)
    ...
    def test_roots_5():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 5.1, cheb_roots=chebfun_roots)
    ...
    def test_roots_6_1():
        ...
        return verbose_pass_or_fail([f,g], yroots, MSroots=None, test_num=6.1, cheb_roots=chebfun_roots)
    ...
    def test_roots_6_2():
        ...
        return verbose_pass_or_fail([f,g], yroots, MSroots=actual_roots, test_num=6.2, cheb_roots=chebfun_roots)
    ...
    def test_roots_6_3():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 6.3, cheb_roots=chebfun_roots)
    ...
    def test_roots_7_1():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 7.1, cheb_roots=chebfun_roots)
    ...
    def test_roots_7_2():
        ...
        return verbose_pass_or_fail([f,g], yroots, MSroots=None, cheb_roots=chebfun_roots, test_num=7.2, tol=2.220446049250313e-11)
    ...
    def test_roots_7_3():
        ...
        return verbose_pass_or_fail([f,g], yroots, MSroots=None, cheb_roots=chebfun_roots, test_num=7.3, tol=2.220446049250313e-9)
    ...
    def test_roots_7_4():
        ...
        return verbose_pass_or_fail([f,g], yroots, MSroots=None, cheb_roots=chebfun_roots, test_num=7.4)
    ...
    def test_roots_8_1():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 8.1, cheb_roots=chebfun_roots)
    ...
    def test_roots_8_2():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 8.2, cheb_roots=chebfun_roots)
    ...
    def test_roots_9_1():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 9.1, cheb_roots=chebfun_roots)
    ...
    def test_roots_9_2():
        ...
        return verbose_pass_or_fail([f,g], yroots, m_sq_roots, 9.2, cheb_roots=chebfun_roots)
    ...
    def test_roots_10():
        ...
        return verbose_pass_or_fail([f,g], yroots, actual_roots, 10.1, cheb_roots=chebfun_roots)
    ...
    score = 0
    for test, test_name in zip(tests,test_nums):
        #print("=========================================================")
        #print("Test", test_name)
        
        try:
            resid, cheb, ms = test()
            res_passes.append(resid)
            cheb_passes.append(cheb)
            MS_passes.append(ms)
            score += resid + cheb + ms
        except TimeoutError:
            pass
    ...
    #score = sum([sum(res_passes), sum(cheb_passes), sum(MS_passes)])

    return sum([sum(res_passes), sum(cheb_passes), sum(MS_passes)])