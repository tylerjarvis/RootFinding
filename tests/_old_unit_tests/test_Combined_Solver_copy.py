...
def solver_check(funcs,a,b):
    ...
    f_approx, f_approx_error = ChebyshevApproximator.chebApproximate(f, a, b)
    g_approx, g_approx_error = ChebyshevApproximator.chebApproximate(g, a, b)
    yroots_2 = np.array(ChebyshevSubdivisionSolver.solveChebyshevSubdivision([f_approx,g_approx],np.array([f_approx_error,g_approx_error])))
...
def test_solver():
    ...
    g_approx, _ = ChebyshevApproximator.chebApproximate(g, a, b)
    h = MultiCheb(g_approx)
    f_approx, _ = ChebyshevApproximator.chebApproximate(f, a, b)
