...
def pass_or_fail(yroots, roots, tol = 1.e-10):#tol = 2.220446e-13):
    """ Determines whether the roots given pass or fail the test according
        to whether or not they are within tol of the "actual" roots, which
        are determined either by previously known roots or Marching Squares
        roots.
    ...
    # all_pass = np.isclose(roots_sorted, yroots_sorted, atol = tol)
    # return all_pass.all()
...
def test_roots_1():
    ...
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest1_1ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 1.1 fails."
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest1_2ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 1.2 fails."

    # Test 1.3
    f = lambda x,y: y**2-x**3
    g = lambda x,y: (y+.1)**3-(x-.1)**2 
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest1_3ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 1.3 fails."
    ...
    assert pass_or_fail(yroots, a_roots), "Test 1.4 fails."
    ...
    assert pass_or_fail(yroots, a_roots), "Test 1.5 fails."
...
def test_roots_2():
    ...
    g = lambda x,y: x + y**2
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest2_1ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 2.1 fails."

    # Test 2.2
    f = lambda x,y: x
    g = lambda x,y: (x-.9999)**2 + y**2-1
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest2_2ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 2.2 fails."

    # Test 2.3
    f = lambda x,y: np.sin(4*(x + y/10 + np.pi/10))
    g = lambda x,y: np.cos(2*(x-2*y+ np.pi/7))
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest2_3ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 2.3 fails."

    # Test 2.4
    f = lambda x,y: x - y + .5
    g = lambda x,y: x + y
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest2_4ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 2.4 fails."
...
def test_roots_3():
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    #m_sq_roots = np.loadtxt('chebfun_test_output/cftest3_1ms.csv',delimiter=',')
    m_sq_roots = np.array()

    assert pass_or_fail(yroots, m_sq_roots), "Test 3.1 fails."
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    #m_sq_roots = np.loadtxt('chebfun_test_output/cftest3_2ms.csv',delimiter=',')
    m_sq_roots = np.array()

    assert pass_or_fail(yroots, m_sq_roots), "Test 3.2 fails."
...
def test_roots_4():
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest4_1ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 4.1 fails."
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest4_2ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 4.2 fails."
...
def test_roots_5():
    ...
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest5_1ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 5.1 fails."
...
def test_roots_6():
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    #m_sq_roots = np.loadtxt('chebfun_test_output/cftest6_1ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 6.1 fails."
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    #m_sq_roots = np.loadtxt('chebfun_test_output/cftest6_2ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 6.2 fails."

    # Test 6.3
    f = lambda x,y: 25*x*y - 12
    g = lambda x,y: x**2+y**2-1
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest6_3ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 6.3 fails."
...
def test_roots_7():
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest7_1ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 7.1 fails."
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest7_2ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 7.2 fails."
    ...
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest7_3ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 7.3 fails."
...
def test_roots_8():
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest8_1ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 8.1 fails."

    # Test 8.2 
    f = lambda x,y: np.sin(10*x-y/10) + y
    g = lambda x,y: np.cos(10*y-x/10) - x
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest8_2ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 8.2 fails."
...
def test_roots_9():
    ...
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest9_1ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 9.1 fails."

    # Test 9.2
    f = lambda x,y: x**2+y**2-.9**2
    g = lambda x,y: np.sin(x*y)
    yroots = solve([f,g],[-1,-1],[1,1])
    m_sq_roots = np.loadtxt('chebfun_test_output/cftest9_2ms.csv',delimiter=',')

    assert pass_or_fail(yroots, m_sq_roots), "Test 9.2 fails."
...
def test_roots_10():
    ...
    assert pass_or_fail(yroots, m_sq_roots), "Test 10.1 fails."
